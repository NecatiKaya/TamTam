...
{
    /// <summary>
    /// Exception that is fired when an argument lentgh is greater then max lentgh.
    /// </summary>
    [Serializable]
    public class ArgumentLengthExceedsException : ExceptionBase
    {
        #region Constructors

        public ArgumentLengthExceedsException()
            : base()
        {

        }

        public ArgumentLengthExceedsException(string message)
            : base(message)
        {

        }

        public ArgumentLengthExceedsException(string message, System.Exception innerException)
            : base(message, innerException)
        {

        }

        public ArgumentLengthExceedsException(SerializationInfo info, StreamingContext sc)
            : base(info, sc)
        {
