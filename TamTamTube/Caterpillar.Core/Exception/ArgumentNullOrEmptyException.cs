...
{
    /// <summary>
    /// Exception that is fired when an argument is null or contains no sequences.
    /// </summary>
    [Serializable]
    public class ArgumentNullOrEmptyException : ExceptionBase
    {
        #region Constructors
        ...
        public ArgumentNullOrEmptyException(string message, System.Exception innerException)
            : base(message, innerException)
        {

        }

        public ArgumentNullOrEmptyException(SerializationInfo info, StreamingContext sc)
            : base(info, sc)
        {
