...
namespace Caterpillar.Core.Exception
{
    ...
    /// </summary>
    [Serializable]
    public class ArgumentLengthShortException : ExceptionBase
    {
        #region Constructors

        public ArgumentLengthShortException()
            : base()
        {

        }

        public ArgumentLengthShortException(string message)
            : base(message)
        {

        }

        public ArgumentLengthShortException(string message, System.Exception innerException)
            : base(message, innerException)
        {

        }

        public ArgumentLengthShortException(SerializationInfo info, StreamingContext sc)
            : base(info, sc)
        {
